...
import orebiFooter from '../assets/orebiFooter.png'

const Footer = () => {
    return (
        <div className='pt-[106px]'>

            <div className='container2 bg-quaternary h-[374px] px-[159px] py-[55px]'>
                <div>
                    <div className='flex'>
                        <div className='mr-[143px]'>
                            <List>
                                <ListItem className='font-dm font-bold text-base text-primary' itemName='Menu' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[17px]' itemName='Home' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Shop' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='About' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Contact' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Journal' />
                            </List>
                        </div>
                        <div className='mr-[141px]'>
                            <List>
                                <ListItem className='font-dm font-bold text-base text-primary' itemName='Shop' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[17px]' itemName='Category1' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Category2' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Category3' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Category4' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Category5' />
                            </List>
                        </div>
                        <div className='mr-[145px]'>
                            <List>
                                <ListItem className='font-dm font-bold text-base text-primary' itemName='HELP' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[17px]' itemName='Privacy Policy' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Terms & Conditions' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Special E-shoput' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='ContacShipping' />
                                <ListItem className='font-dm text-sm text-[#6D6D6D] pt-[6px]' itemName='Secure Payments' />
                            </List>
                        </div>
                        <div className='mr-[256px]'>
                            <h1 className='w-[186px] h-[54px] text-primary font-bold text-base font-dm'>(052) 611-5711
                                company@domain.com</h1>
                            <p className='text-[#6D6D6D] text-sm font-dm'>575 Crescent Ave. Quakertown, PA 18951</p>
                        </div>
                        <div>
                            <img src={orebiFooter} alt="" />
                        </div>
                    </div>
                    <div className='flex items-center justify-between pt-[65px]'>
                        ...
                        <div>
                            <p className='text-[#6D6D6D] text-sm font-dm'>2020 Orebi Minimal eCommerce Figma Template by Adveits</p>
                        </div>
                    </div>
                </div>
            </div>
