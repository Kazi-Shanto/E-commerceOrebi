        ...
        <div className='border-b-2'>
            ...
            <Container className='flex items-center justify-between py-[22px]'>
                <div className='flex gap-x-4'>
                    ...
                    <div>
                        <p className='text-[#6D6D6D] font-dm text-base'>Two years warranty</p>
                    </div>
                </div>
                <div className='flex gap-x-4'>
                    <div>
                    ...
                    <div>
                        <p className='text-[#6D6D6D] font-dm text-base'>Free shipping</p>
                    </div>
                </div>
                <div className='flex gap-x-4'>
                    <div>
                    ...
                    <div>
                        <p className='text-[#6D6D6D] font-dm text-base'>Return policy in 30 days</p>
                    </div>
                </div>
            </Container>
